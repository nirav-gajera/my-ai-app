...
<div id="knowledge-page"
     ...
     data-routes='@json(["knowledgeDocuments" => route("knowledge-documents.store")])'>
            ...
            <div class="card-body">
                <form class="upload-form" id="knowledge-form">
                    <div class="form-group">
                        ...
                        <input id="document-title" name="title" type="text" class="form-input"
                               maxlength="255" placeholder="Friendly name (optional)">
                    </div>

                    <div class="form-group">
                        <label class="form-label" for="document-file">Upload a file</label>
                        <input id="document-file" name="file" type="file" class="form-input"
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="document-content" name="content" class="form-input" rows="8"
                            placeholder="Paste policies, FAQs, playbooks, or any text you want to make searchable..."></textarea>
                    </div>
